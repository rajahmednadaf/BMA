                                            ...
                                            <div class="form-row">                  
                                                <div class="col-md-6">  
                                                    <div class="form-label-group">
                                                        ...
                                                        <input type="text" id="firstName" class="form-control" value="<?php echo $row['emp_gname']; ?>" required="required" autofocus="autofocus" name="firstname">
                                                    </div>
                                                </div>  
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="lastName">Last Name</label>    
                                                        <input type="text" id="lastName" class="form-control" value="<?php echo $row['emp_lastname']; ?>" required="required" name="lastname">       
                                                    </div>
                                                    <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">                  
                                                <div class="col-md-6">  
                                                    <div class="form-label-group">
                                                        ...
                                                        <input type="text" id="fatherName" class="form-control" value="<?php echo $row['emp_fname']; ?>" required="required" autofocus="autofocus" name="fatherName">
                                                    </div>
                                                </div>  
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="grandfatherName">Grandfather's Name</label>    
                                                        <input type="text" id="grandfatherName" class="form-control" value="<?php echo $row['emp_gfname']; ?>" required="required" name="grandfatherName">       
                                                    </div>
                                                    <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">                  
                                                ...
                                                <div class="col-md-4">          
                                                    <div class="form-label-group">
                                                        ...
                                                        <input type="text" id="designation" class="form-control" value="<?php echo $row['emp_desig']; ?>" required="required" name="designation">       
                                                    </div>
                                                    <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">                  
                                                <div class="col-md-6">  
                                                    <div class="form-label-group">
                                                        ...
                                                        <input type="text" id="dateOfJoining" class="form-control" value="<?php echo $row['emp_DOJ']; ?>" required="required" autofocus="autofocus" name="doj">
                                                    </div>
                                                </div>        
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                                        <label for="salaryPerMonth">Salary</label>    
                                                        <input type="text" id="salaryPerMonth" class="form-control" value="<?php echo $row['emp_salary']; ?>" required="required" name="salary">       
                                                    </div>
                                                    <br>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4">  
                                                    <div class="form-label-group">
                                                        ...
                                                        <input type="text" id="tempVillage" class="form-control" value="<?php echo $row['emp_Tvillage']; ?>" required="required" autofocus="autofocus" name="tempvillage">
                                                    </div>
                                                </div>  
                                                <div class="col-md-4">  
                                                    <div class="form-label-group">
                                                        <label for="tempDistrict">District</label>
                                                        <input type="text" id="tempDistrict" class="form-control" value="<?php echo $row['emp_Tdistrict']; ?>" required="required" autofocus="autofocus" name="tempdistrict">
                                                    </div>
                                                </div>                                                
                                                <div class="col-md-4">
                                                    <div class="form-label-group">
                                                        <label for="tempProvences">Provences</label>    
                                                        <input type="text" id="tempProvences" class="form-control" value="<?php echo $row['emp_Tprovince']; ?>" required="required" name="tempprovences">       
                                                    </div>
                                                    <br>                                                        
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4">  
                                                    <div class="form-label-group">
                                                        ...
                                                        <input type="text" id="PerVillage" class="form-control" value="<?php echo $row['emp_Pvillage']; ?>" required="required" autofocus="autofocus" name="village">
                                                    </div>
                                                </div>  
                                                <div class="col-md-4">  
                                                    <div class="form-label-group">
                                                        <label for="perDistrict">District</label>
                                                        <input type="text" id="perDistrict" class="form-control" value="<?php echo $row['emp_Pdistrict']; ?>" required="required" autofocus="autofocus" name="district">
                                                    </div>
                                                </div>                                                
                                                <div class="col-md-4">
                                                    <div class="form-label-group">
                                                        <label for="perProvences">Provences</label>    
                                                        <input type="text" id="perProvences" class="form-control" value="<?php echo $row['emp_Pprovince']; ?>" required="required" name="provences">       
                                                    </div>
                                                    <br>                                                        
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row"> 
                                                <div class="col-md-6">  
                                                    <div class="form-label-group">
                                                        ...
                                                        <input type="text" id="mobileNumber" class="form-control" value="<?php echo $row['emp_phoneNo']; ?>" required="required" autofocus="autofocus" name="mobile">
                                                    </div>
                                                </div>                                                
                                                <div class="col-md-6">
                                                    <div class="form-label-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="emailID" class="form-control" value="<?php echo $row['emp_emailAdd']; ?>" required="required" name="email">       
                                        </div>
                                        <br>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tazkeraNumber" class="form-control" value="<?php echo $row['emp_Tazkera']; ?>" required="required" autofocus="autofocus" name="taz">        
                                    </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4">  
                                                <div class="form-label-group">
                                                    ...
                                                    <input type="text" id="birthPlace" class="form-control" value="<?php echo $row['emp_pob']; ?>" required="required" autofocus="autofocus" name="birthplace">
                                                </div>
                                            </div>  
                                            <div class="col-md-4">  
                                                <div class="form-label-group">
                                                    <label for="dateOfBirth">Date of Birth</label>
                                                    <input type="text" id="dateOfBirth" class="form-control" value="<?php echo $row['emp_dob']; ?>" required="required" autofocus="autofocus" name="dob">
                                                </div>
                                            </div>                                                
                                            <div class="col-md-4">
                                                <div class="form-label-group">
