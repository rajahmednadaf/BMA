...
<head>
	...
	<link href="assets/scripts/dateick.js" rel="stylesheet"/>
...
<body>
                                                ...
                                                <div class="col-md-4">  
                                                    <div class="form-label-group">
														...
														<select class="form-control" name="emptype">
                                                            <option id="branchNameID1" value="branchNameVal1">branchName1</option>
                                                            <option id="branchNameID2" value="branchNameVal2">branchName2</option>
                                                        </select> 
                                                      </div>
                                                </div>
                                                <div class="col-md-4">  
                                                    <div class="form-label-group">
														...
														<select class="form-control" name="emptype">
                                                            <option id="departmentNameID1" value="departmentNameVal1">Department Name1</option>
                                                            <option id="departmentNameID2" value="departmentNameVal2">Department Name2</option>
                                                        </select> 
                                                    </div>
                                                </div>
                                                <div class="col-md-4">          
                                            ...
                                            <div class="form-row">                  
                                                ...
                                                <div class="col-md-6">  
                                                    <div class="form-label-group">
                                                        <label>Manager</label>
														<select class="form-control" name="emptype">
                                                            <option id="ManagerID1" value="ManagerIDVal1">Manager1</option>
                                                            <option id="ManagerID2" value="ManagerIDVal2">Manager2			</option>
                                                        </select> 
                                                    </div>
                                                    <br>
                                                </div>
	...
	<script src="assets/scripts/datepick.js"></script>
